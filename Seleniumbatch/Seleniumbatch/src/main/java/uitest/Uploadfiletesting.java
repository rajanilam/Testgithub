...
public class Uploadfiletesting {
    ...
    public void test_file_upload() {
        driver.get("https://demoqa.com/upload-download");// This will get the website link
        driver.findElement(By.xpath("//input[@id='uploadFile']")).sendKeys("C:\\Users\\ASUS\\Desktop\\git example\\seleniumwithjava\\downloads\\sampleFile.jpeg");//xpath for upload tab provided
