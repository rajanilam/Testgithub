...
public class Seleniumtestxpath {
...
//        driver.findElement(By.xpath("button[id='add_to_cart']")).click();
            //Thread.sleep(2000);
            String errortext = driver.findElement(By.xpath("//div[@class='error-message-container error']/h3[contains(text(),'Sorry, this user has been locked out.')]")).getText();
